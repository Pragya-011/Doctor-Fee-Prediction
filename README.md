...
### Data Preprocessing
- In the preprocessing phase data is cleaned, missing values are handled, and exploratory data analysis is performed. The Jupyter Notebook `Preprocessing and EDA.ipynb` includes the cleaning and visualization code.
...
- `Dr-Fee-Predict-Presentation.pdf`: Presentation showcasing project details and insights.
